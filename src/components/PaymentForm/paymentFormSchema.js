...
export default Yup.object().shape({
    creditCardNumber: Yup.string().min(16, 'O campo deve conter 16 números').matches(/^[0-9]{16}$/i, 'Neste campo só é permitido números' ).required( 'O preenchimento do campo é obrigatório' ),
